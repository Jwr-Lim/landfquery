...
WHERE C.ORDER_NO in ('PD250929001')
...
WHERE A.ORDER_NO in ('PD250929001')
...
DELETE PD_USEM_MAT_TEMP WHERE ORDEr_NO = 'PD250929001'
DELETE PD_USEM_MAT_TEMP_MASTER WHERE ORDER_NO = 'PD250929001'
DELETE PD_MDM_RESULT_MASTER WHERE ORDEr_NO = 'PD250929001'
/*
UPDATE A SET A.END_DT = NULL 
FROM PD_MDM_RESULT_PROC_SPEC A WITH (NOLOCK) 
*/
DELETE PD_MDM_RESULT_PROC_SPEC WHERE ORDER_NO = 'PD250929001'
DELETE PD_MDM_WORK_SEND WHERE ORDER_NO = 'PD250929001'
